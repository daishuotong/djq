...
public class SelfFrame extends JFrame implements ActionListener{
	...
	public SelfFrame(int index) {
		...
		textField_1.setBounds(170, 39, 130, 21);
		...
		passwordField.setBounds(170, 90, 130, 21);
		...
		comboBox_2.setBounds(170, 139, 130, 21);
		...
		comboBox.setBounds(170, 39, 130, 21);
		panel_1.add(comboBox);
		
		passwordField_1 = new JPasswordField();
		passwordField_1.setBounds(170, 90, 130, 21);
		panel_1.add(passwordField_1);
		
		comboBox_1.setBounds(170, 139, 130, 21);
	...
	static class deleteuser implements ActionListener
	{
		public void actionPerformed(ActionEvent e) {
			...
			if(copy  == JOptionPane.YES_OPTION)
			{
				...
				try {
					if(DataProcessing.deleteUser(x))
					{
						GenerateTable();
